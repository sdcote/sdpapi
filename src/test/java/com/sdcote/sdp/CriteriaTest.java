...
class CriteriaTest {
    ...
    @Test
    void basicTest() {
        Criteria root = new Criteria("name", "contains", "MacBook");

        // Chain the next condition (AND)
        // This defines: Name contains MacBook AND Status is In Store
        Criteria condition2 = new Criteria("state.name", "is", "In Store");
        ...
        Criteria condition3 = new Criteria("site.name", "is", "New York");
    ...
    void parse1() {
        ...
        Criteria root = new Criteria(frames.get(0));
